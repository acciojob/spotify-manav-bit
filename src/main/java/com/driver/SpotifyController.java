...
spotifyService.createAlbum(title,artistName);
    ...
    public String createSong(@RequestParam String title, String albumName, int length) throws Exception{
...
spotifyService.createSong(title,albumName,length);
    ...
    public String createPlaylistOnLength(@RequestParam String mobile, String title, int length) throws Exception{
...
spotifyService.createPlaylistOnLength(mobile,title,length);
    ...
    public String createPlaylistOnName(@RequestParam String mobile, String title, List<String> songTitles) throws Exception{
...
spotifyService.createPlaylistOnName(mobile,title,songTitles);
    ...
    public Playlist findPlaylist(@RequestParam String mobile, String playlistTitle) throws Exception{
...
return spotifyService.findPlaylist(mobile, playlistTitle);
    ...
    public Song likeSong(@RequestParam String mobile, String songTitle) throws Exception{
